...
the following derivation, if $x_1 = x_2$m $y_1 = y_2$; here $t_1 = \mathtt{false}\; x_1$, 
...
\TrinaryInfC{$z:0 \vdash_C, \mathtt{mkc}(t_1,y_1): S - T, \mathtt{mkc}(t_2,y_2): S - T, y_1(t): T, y_2(t): T$}
\DisplayProof
\]
}
