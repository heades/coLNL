...
sequent $x:T_2 \vdash_C \Psi_2$, the minor premise of the rule. In the conclusion 
...
A notion of $\alpha$ conversion has been proposed for this notion of binding in untyped 
linear contexts in  \cite{Bellin:2012}. In the term assignment.   

In the term assignment 
  substitution, denoted by $[[ [t1/x]t2]]$, $[[[e/x]t]]$, $[[ [t/x]e]]$, and $[[ [e1/x]e2]]$, is defined in the
