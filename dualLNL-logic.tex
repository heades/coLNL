...
\noLine
\UnaryInfC{$x:S \vdash_{\mathsf{C}} x:S  $}
\DisplayProof\\

\\
 \AxiomC{\it C zero}
\noLine
\UnaryInfC{$x:S\vdash_{\mathsf{C}} t:0, \Psi \qquad x_1:S_1 \vdash_{\mathsf{C}} \Psi_1\quad \ldots\quad x_n:S_n \vdash \Psi_n$} 
\UnaryInfC{$x:S \vdash_{\mathsf{C}}  \Psi, [\mathtt{false}\;t/x_1]\Psi_1\quad \ldots\quad[\mathtt{false}\;t/x_n]\Psi_n$} 
\DisplayProof\\
\\
\AxiomC{\it C subtraction intro }
\noLine
\UnaryInfC{$x:S \vdash_{\mathsf{C}} \Psi_1, t: T_1 \qquad  
y:T_2 \vdash_{\mathsf{C}} \Psi_2$}
\UnaryInfC{$x:S \vdash_{\mathsf{C}} \Psi_1, \mathtt{mkc}(t,y): T_1 - T_2,  [y(t)/y] \Psi_2$}
\DisplayProof\\
\\
\AxiomC{\it C subtraction elim}
\noLine
\UnaryInfC{$x: S \vdash_{\mathsf{C}} \Psi_1, s:T_1 - T_2\qquad y: T_1 \vdash_{\mathsf{C}} t: T_2, \Psi_2$}
\UnaryInfC{$x: S \vdash_{\mathsf{C}} \Psi_1, \mathtt{postp}(y\mapsto t, s), [y(s)/y]\Psi_2$} 
\DisplayProof\\
\\
\AxiomC{\it C disjunction intro$_1$}
\noLine
\UnaryInfC{$x: S \vdash_{\mathsf{C}}  \Psi, t_1: T_1$}
\UnaryInfC{$x: S \vdash_{\mathsf{C}}  \Psi, \mathtt{inl}\; t_1: T_1 + T_2$}
\DisplayProof \qquad
\AxiomC{\it C disjunction intro$_2$}
\noLine
\UnaryInfC{$x: S \vdash_{\mathsf{C}}  \Psi, t_2: T_2$}
\UnaryInfC{$x: S \vdash_{\mathsf{C}}  \Psi, \mathtt{inr}\; t_2:  T_1 + T_2$}
\DisplayProof \\
\\
\AxiomC{\it C disjunction elim}
\noLine
\UnaryInfC{$x: S \vdash_{\mathsf{C}} \Psi, t: T_1 + T_2 \qquad y: T_1 \vdash_{\mathsf{C}} \Psi_1 \quad z: T_2 \vdash_{\mathsf{C}} \Psi_2\quad 
|\Psi_1| = |\Psi_2|$}
\UnaryInfC{$x: S \vdash_{\mathsf{C}} \Psi, \mathtt{case}\; t\; \mathtt{of}\; y.\Psi_1, z.\Psi_2$}
\DisplayProof\\
\\
\AxiomC{\it H elim$_2$}
\noLine
\UnaryInfC{$x: S \vdash_{\mathsf{C}} \Psi_1, t: HA \qquad y: A \vdash_{\mathsf{L}} ; \Psi_2\qquad |\Psi_1| = |\Psi_2|$}
\UnaryInfC{$S \vdash_{\mathsf{C}} \Psi_1 \cdot (\mathtt{let}\; Hy = t\: \mathtt{in}\; \Psi_2)$}
\DisplayProof\\
\\
\\
\hline
...
\noLine
\UnaryInfC{$x: A \vdash_{\mathsf{L}} x: A $}
\DisplayProof\\
\\
 \AxiomC{\it $\bot$ intro}
\noLine
...
\UnaryInfC{$x:A \vdash_{\mathsf{L}} \mathtt{postp}_{\bot}\;e, \Delta ; \Psi$}
\DisplayProof\\
\\
\AxiomC{\it L subtraction intro }
\noLine
\UnaryInfC{$x: A \vdash_{\mathsf{L}} \Delta_1, e: B_1 ; \Psi_1 \qquad  
y: B_2 \vdash_{\mathsf{L}} \Delta_2; \Psi_2$}
\UnaryInfC{$x: A \vdash_{\mathsf{L}} \mathtt{mkc}(e, y) : B_1 \lsub B_2, \Delta_1, [y(e)] / y]\Delta_2; \Psi_1, [y(e)] / y]\Psi_2$}
\DisplayProof\\
\\
\AxiomC{\it L subtraction elim}
\noLine
\UnaryInfC{$x: A \vdash_{\mathsf{L}} \Delta_1, e: B_1 \lsub B_2;\Psi_1\qquad y :B_1 \vdash_{\mathsf{L}} e': B_2, \Delta_2 ;  \Psi_2$}
\UnaryInfC{$x: A \vdash_{\mathsf{L}} \Delta_1, \mathtt{postp}(y\mapsto e', e), \Delta_2 ; \Psi_1, \Psi_2$}
\DisplayProof
\\
\\
\AxiomC{\it L disjunction intro}
\noLine
\UnaryInfC{$x: A \vdash_{\mathsf{L}} \Delta, e_1: B_1, e_2: B_2;  \Psi$}
\UnaryInfC{$x: A \vdash_{\mathsf{L}} \Delta, e_1\oplus e_2: B_1\oplus B_2;  \Psi$}
\DisplayProof \\
\\
\AxiomC{\it L disjunction elim$_2$}
\noLine
\UnaryInfC{$x: A \vdash_{\mathsf{L}} \Delta, e: B_1\oplus B_2 ; \Psi \qquad y: B_1 \vdash_{\mathsf{L}} \Delta_1; \Psi_1 \quad z: B_2 \vdash_{\mathsf{L}}  \Delta_2; \Psi_2$}
\UnaryInfC{$x: A \vdash_{\mathsf{L}} \Delta, [\mathtt{casel}(e)/y]\Delta_1, [\mathtt{caser}(e)/z]\Delta_2 ; \Psi, [\mathtt{casel}(e)/y]\Psi_1, [\mathtt{caser}(e)/z]\Psi_2$}
\DisplayProof \\
\\
\AxiomC{\it J intro}
\noLine
\UnaryInfC{$A \vdash_{\mathsf{L}}, \Delta ; T, \Psi $}
