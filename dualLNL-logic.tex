...
\end{tabular}
\end{center}
\subsection{Bound variables and substitution.}
\begin{definition}
...
\section{Categorical interpretation of rules}
...
a morphism $[\![f]\!] : [\![\sigma_1]\!]\bullet\ldots\bullet[\![\sigma_n]\!]\rightarrow [\![\tau]\!]$ for each function $f : \sigma_1, \ldots, \sigma_n \rightarrow \tau$ of $Sg$.\footnote{ In this section only we use the symbol $\bullet$ and 1 for the monoidal binary operation and its unit in the categorical structure, distinguished from the $\oplus$ and $\bot$ symbols 
...
\subsection{Linear disjunction Par}\label{lindisj} 
...
\subsection{Linear subtraction}\label{linsubtr}
