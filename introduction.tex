...
\begin{mathpar}
  \inferrule* [right=$\func{H}_r$] {
    A \vdash_{\cat{L}} \delta,B;\Psi
  }{A \vdash_{\cat{L}} \delta;\func{H}B,\Psi}
  \and
  \inferrule* [right=$\func{H}_l$] {
    A \vdash_{\cat{L}} .;\Psi
  }{\func{H}A \vdash_{\cat{C}} \Psi}
  \and
  \inferrule* [right=$\func{J}_r$] {
    A \vdash_{\cat{L}} \Delta;T,\Psi
  }{A \vdash_{\cat{L}} \Delta,\func{J}T;\Psi}
  \and  
  \inferrule* [right=$\func{J}_l$] {
    T \vdash_{\cat{C}} \Psi
  }{\func{J}T \vdash_{\cat{L}} .;\Psi}
\end{mathpar}
