...
\renewcommand{\DualLNLLogicdruleLXXjLName}{\text{LL\_}\func{J}_L}
\renewcommand{\DualLNLLogicdruleLXXjRName}{\text{LL\_}\func{J}_R}
\renewcommand{\DualLNLLogicdruleLXXhRName}{\text{LL\_}\func{H}_R}
