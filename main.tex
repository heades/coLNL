...
\renewcommand{\DualLNLLogicdruleNCXXidName}{\text{id}}
\renewcommand{\DualLNLLogicdruleNCXXzIName}{0_E}
\renewcommand{\DualLNLLogicdruleNCXXdIOneName}{+_{I_1}}
\renewcommand{\DualLNLLogicdruleNCXXdITwoName}{+_{I_2}}
\renewcommand{\DualLNLLogicdruleNCXXdEName}{+_E}
\renewcommand{\DualLNLLogicdruleNCXXsubIName}{-_I}
\renewcommand{\DualLNLLogicdruleNCXXsubEName}{-_E}
\renewcommand{\DualLNLLogicdruleNCXXHEName}{\func{H}_E}

\renewcommand{\DualLNLLogicdruleNLXXidName}{\text{id}}
\renewcommand{\DualLNLLogicdruleNLXXpIName}{\perp_I}
\renewcommand{\DualLNLLogicdruleNLXXpEName}{\perp_E}
\renewcommand{\DualLNLLogicdruleNLXXparIName}{\oplus_I}
\renewcommand{\DualLNLLogicdruleNLXXparEName}{\oplus_E}
\renewcommand{\DualLNLLogicdruleNLXXsubIName}{\colimp_I}
\renewcommand{\DualLNLLogicdruleNLXXsubEName}{\colimp_E}
\renewcommand{\DualLNLLogicdruleNLXXJIName}{\func{J}_I}
\renewcommand{\DualLNLLogicdruleNLXXJEName}{\func{J}_E}
\renewcommand{\DualLNLLogicdruleNLXXHIName}{\func{H}_I}
\renewcommand{\DualLNLLogicdruleNLXXHEName}{\func{H}_E}
